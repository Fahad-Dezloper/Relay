        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="">
                  <p className="text-sm text-gray-500">Connect with your creators</p>
                </div>
                <div className='flex'>
                  <Input placeholder='Generate Token' />
                  <Button className="ml-2" type="button">Generate</Button>
                </div>


                 <ScrollArea className="h-44 mt-5 w-full rounded-md border">
                    <div className="p-4">
                      <h4 className="mb-4 text-sm leading-none font-semibold">Currently Connected Editors</h4>
                      {tags.map((tag) => (
                        <>
                          <div key={tag} className="text-sm flex justify-between items-center">
                            {tag}
                            <div className='flex gap-5'>
                              <X className='hover:bg-red-300 duration-200 ease-in-out text-red-600 rounded-full p-[3px] cursor-pointer' />
                            </div>
                          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className='flex w-full justify-end text-[#666666] font-semibold pr-10'>Status</div>
                <ul className="space-y-2 mt-2 flex flex-col gap-3">
                  <li className='flex justify-between w-full items-center'>
                    <span>Client Name</span>
                    <span className='text-sm px-4 py-2 bg-yellow-200 font-semibold text-black rounded-full'>Review Pending</span>
                  </li>
                  <li className='flex justify-between w-full items-center'>
                    <span>Client Name</span>
                    <span className='text-sm px-4 py-2 bg-red-200 font-semibold text-black rounded-full'>Review Recieved</span>
                  </li>
                  <li className='flex justify-between w-full items-center'>
                    <span>Client Name</span>
                    <span className='text-sm px-4 py-2 bg-green-200 font-semibold text-black rounded-full'>Approved</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
  ...
  return (
    <div className="flex h-fit bg-gray-100">
      ...
      <div className="flex-1 p-10">
        <h2 className="text-3xl font-bold mb-6">Welcome, Editor!</h2>
        {renderContent()}
      </div>
    </div>
  )
